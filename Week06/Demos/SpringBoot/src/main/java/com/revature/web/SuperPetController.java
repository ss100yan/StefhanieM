...
//	}
	...
	@GetMapping(value="/power/{power}", produces=MediaType.APPLICATION_JSON_VALUE)
	public SuperPet getSuperPetByPower(@PathVariable String power) {
		return this.superPetService.getSuperPetByPower(power);
	}
	
	@GetMapping(value="/power/many/{power}", produces=MediaType.APPLICATION_JSON_VALUE)
	public List<SuperPet> getSuperPetsByPower(@PathVariable String power){
		return this.superPetService.getSuperPetsByPower(power);
	}
